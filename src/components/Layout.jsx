    ...
    return (
        <div className="min-h-screen bg-background text-main font-sans transition-colors duration-300">
            ...
            <footer className="py-8 text-center text-muted text-sm transition-colors duration-300">
                <p>&copy; {new Date().getFullYear()} Harmonia Christi &middot; Created by <a href="https://corneluu.github.io/corneluu/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-all duration-300 underline decoration-primary/40 hover:decoration-primary underline-offset-4">Cornel</a></p>
            </footer>
        </div>
    );
};
